...
contains
  ...
  subroutine micro_p3_init(pbuf2d)
    ...
    call addfld("T_atm_inP3",          (/ 'lev' /),  'I', 'unitless', "T_atm"          ) 
    call addfld("ast_inP3",            (/ 'lev' /),  'I', 'unitless', "ast"            ) 
    call addfld("ni_activated_inP3",   (/ 'lev' /),  'I', 'unitless', "ni_activated"   ) 
    call addfld("nc_nuceat_tend_inP3", (/ 'lev' /),  'I', 'unitless', "nc_nuceat_tend" ) 
    call addfld("pmid_inP3",           (/ 'lev' /),  'I', 'unitless', "pmid"           ) 
    call addfld("dp_inP3",             (/ 'lev' /),  'I', 'unitless', "dp"             ) 
    call addfld("zi_inP3",             (/ 'ilev' /), 'I', 'unitless', "zi"             ) 
    call addfld("qv_prev_inP3",        (/ 'lev' /),  'I', 'unitless', "qv_prev"        ) 
    call addfld("T_prev_inP3",         (/ 'lev' /),  'I', 'unitless', "T_prev"         ) 
    call addfld("qv_inP3",             (/ 'lev' /),  'I', 'unitless', "qv"             ) 
    call addfld("qc_inP3",             (/ 'lev' /),  'I', 'unitless', "qc"             ) 
    call addfld("qr_inP3",             (/ 'lev' /),  'I', 'unitless', "qr"             ) 
    call addfld("qi_inP3",             (/ 'lev' /),  'I', 'unitless', "qi"             ) 
    call addfld("qm_inP3",             (/ 'lev' /),  'I', 'unitless', "qm"             ) 
    call addfld("nc_inP3",             (/ 'lev' /),  'I', 'unitless', "nc"             ) 
    call addfld("nr_inP3",             (/ 'lev' /),  'I', 'unitless', "nr"             ) 
    call addfld("ni_inP3",             (/ 'lev' /),  'I', 'unitless', "ni"             ) 
    call addfld("bm_inP3",             (/ 'lev' /),  'I', 'unitless', "bm"             ) 
    call addfld("nccn_prescribed_inP3",(/ 'lev' /),  'I', 'unitless', "nccn_prescribed") 
    call addfld("inv_qc_relvar_inP3",  (/ 'lev' /),  'I', 'unitless', "inv_qc_relvar"  ) 
    ! Add fields to output that are needed for p3-stand-alone test: OUTPUT
    call addfld("T_atm_outP3",               (/ 'lev' /),  'I', 'unitless', "T_atm_outP3"              ) 
    call addfld("T_prev_outP3",              (/ 'lev' /),  'I', 'unitless', "T_prev_outP3"             ) 
    call addfld("qv_prev_outP3",             (/ 'lev' /),  'I', 'unitless', "qv_prev_outP3"            ) 
    call addfld("lamc_outP3",                (/ 'lev' /),  'I', 'unitless', "lamc_outP3"               ) 
    call addfld("precip_total_tend_outP3",   (/ 'lev' /),  'I', 'unitless', "precip_total_tend_outP3"  ) 
    call addfld("mu_c_outP3",                (/ 'lev' /),  'I', 'unitless', "mu_c_outP3"               ) 
    call addfld("nevapr_outP3",              (/ 'lev' /),  'I', 'unitless', "nevapr_outP3"             ) 
    call addfld("qr_evap_tend_outP3",        (/ 'lev' /),  'I', 'unitless', "qr_evap_tend_outP3"       ) 
    call addfld("liq_ice_exchange_outP3",    (/ 'lev' /),  'I', 'unitless', "liq_ice_exchange_outP3"   ) 
    call addfld("vap_liq_exchange_outP3",    (/ 'lev' /),  'I', 'unitless', "vap_liq_exchange_outP3"   ) 
    call addfld("vap_ice_exchange_outP3",    (/ 'lev' /),  'I', 'unitless', "vap_ice_exchange_outP3"   ) 
    call addfld("bm_outP3",                  (/ 'lev' /),  'I', 'unitless', "bm_outP3"                 ) 
    call addfld("nc_outP3",                  (/ 'lev' /),  'I', 'unitless', "nc_outP3"                 ) 
    call addfld("ni_outP3",                  (/ 'lev' /),  'I', 'unitless', "ni_outP3"                 ) 
    call addfld("nr_outP3",                  (/ 'lev' /),  'I', 'unitless', "nr_outP3"                 ) 
    call addfld("qc_outP3",                  (/ 'lev' /),  'I', 'unitless', "qc_outP3"                 ) 
    call addfld("qi_outP3",                  (/ 'lev' /),  'I', 'unitless', "qi_outP3"                 ) 
    call addfld("qm_outP3",                  (/ 'lev' /),  'I', 'unitless', "qm_outP3"                 ) 
    call addfld("qr_outP3",                  (/ 'lev' /),  'I', 'unitless', "qr_outP3"                 ) 
    call addfld("qv_outP3",                  (/ 'lev' /),  'I', 'unitless', "qv_outP3"                 ) 
    call addfld("diag_eff_radius_qc_outP3",  (/ 'lev' /),  'I', 'unitless', "diag_eff_radius_qc_outP3" ) 
    call addfld("diag_eff_radius_qi_outP3",  (/ 'lev' /),  'I', 'unitless', "diag_eff_radius_qi_outP3" ) 
...
! thus when considering any dp/dz calculation we must also change the sign.
    ...
    call outfld("T_atm_inP3",           state%T,                pcols, lchnk) 
    call outfld("ast_inP3",             ast,                    pcols, lchnk) 
    call outfld("ni_activated_inP3",    ni_activated,           pcols, lchnk) 
    call outfld("nc_nuceat_tend_inP3",  npccn,                  pcols, lchnk) 
    call outfld("pmid_inP3",            state%pmid,             pcols, lchnk) 
    call outfld("dp_inP3",              state%pdel  ,           pcols, lchnk) 
    call outfld("zi_inP3",              state%zi,               pcols, lchnk) 
    call outfld("qv_prev_inP3",         qv_prev,                pcols, lchnk) 
    call outfld("T_prev_inP3",          T_prev,                 pcols, lchnk) 
    ...
    call outfld("nccn_prescribed_inP3", nccn_prescribed,        pcols, lchnk) 
...
!====================== COSP Specific Outputs  END ======================!
    ...
    call outfld("T_atm_outP3",               state%T,           pcols, lchnk) 
    call outfld("T_prev_outP3",              t_prev,            pcols, lchnk) 
    call outfld("qv_prev_outP3",             qv_prev,           pcols, lchnk) 
    call outfld("lamc_outP3",                lambdac,           pcols, lchnk) 
    call outfld("precip_total_tend_outP3",   precip_total_tend, pcols, lchnk) 
    call outfld("mu_c_outP3",                mu,                pcols, lchnk) 
    call outfld("nevapr_outP3",              nevapr,            pcols, lchnk) 
    call outfld("qr_evap_tend_outP3",        qr_evap_tend,      pcols, lchnk) 
    ...
    call outfld("diag_eff_radius_qc_outP3",  rel,               pcols, lchnk) 
    call outfld("diag_eff_radius_qi_outP3",  rei,               pcols, lchnk) 
    !=============
