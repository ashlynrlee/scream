...
! Broadcast namelist variables
  ...
  !------------------------------------------------------------------- !  
    ...
    call addfld( "pref_mid_inSHOC",         (/'lev'/),          'I', 'Pa',       "pref_mid")
 ...
 !  Get indicees for cloud and ice mass and cloud and ice number
   ...
   call outfld( "qc_inSHOC",               state1%q(i,k,ixcldliq), pcols, lchnk )
   call outfld( "qv_inSHOC",               state1%q(i,k,ixq),      pcols, lchnk )
